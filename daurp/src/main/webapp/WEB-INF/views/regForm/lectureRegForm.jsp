...
<form action="${pageContext.request.contextPath} /lecture/lectureEnroll" onsubmit="return chk()">
    <table width = "1400" height="650">
        <tr>
            <td width="60%" align="center">
                ...
                <br>
                <textarea rows="20" cols="150" readonly>동아대학교 산학연연구단지조성사업단에서는 스마트팩토리 운영관리사 양성과정(자격증 교육)과 관련하여
...
개인정보를 제공받는 자의 개인정보 이용목적 : 스마트 팩토리 운영관리사 양성 및 교육

※ 귀하께서는 개인정보 제공 및 활용에 거부할 권리가 있습니다.
☞ 거부에 따른 불이익 : 위 제공사항은 동아대학교 산학연연구단지조성사업단에서 관리하는 스마트 팩토리 운영관리사
양성과정(자격증 교육)에 반드시 필요한 사항으로 거부하실 경우 양성과정 신청이 불가함을 알려드립니다.
                </textarea>
                <p>
